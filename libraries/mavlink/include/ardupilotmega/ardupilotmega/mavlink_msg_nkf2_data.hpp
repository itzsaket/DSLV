// MESSAGE NKF2_DATA support class
...
/**
 * @brief NKF2_DATA message
 *
 * NKF2
 */
struct NKF2_DATA : mavlink::Message {
    static constexpr msgid_t MSG_ID = 11098;
    static constexpr size_t LENGTH = 43;
    static constexpr size_t MIN_LENGTH = 43;
    static constexpr uint8_t CRC_EXTRA = 115;
    static constexpr auto NAME = "NKF2_DATA";
