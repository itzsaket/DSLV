...
TEST(ardupilotmega, NKF2_DATA)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::NKF2_DATA packet_in{};
    packet_in.TimeUS = 93372036854775807ULL;
    packet_in.innovDragX = 73.0;
    packet_in.innovDragY = 101.0;
    packet_in.innovSideslip = 129.0;
    packet_in.accbiasX = 18275;
    packet_in.accbiasY = 18379;
    packet_in.accbiasZ = 18483;
    packet_in.windN = 18587;
    packet_in.windE = 18691;
    packet_in.magN = 18795;
    packet_in.magE = 18899;
    packet_in.magD = 19003;
    packet_in.magX = 19107;
    packet_in.magY = 19211;
    packet_in.magZ = 19315;
    packet_in.Core = 3;

    mavlink::ardupilotmega::msg::NKF2_DATA packet1{};
    mavlink::ardupilotmega::msg::NKF2_DATA packet2{};
    ...
    EXPECT_EQ(packet1.TimeUS, packet2.TimeUS);
    EXPECT_EQ(packet1.innovDragX, packet2.innovDragX);
    EXPECT_EQ(packet1.innovDragY, packet2.innovDragY);
    EXPECT_EQ(packet1.innovSideslip, packet2.innovSideslip);
    EXPECT_EQ(packet1.accbiasX, packet2.accbiasX);
    EXPECT_EQ(packet1.accbiasY, packet2.accbiasY);
    EXPECT_EQ(packet1.accbiasZ, packet2.accbiasZ);
    EXPECT_EQ(packet1.windN, packet2.windN);
    EXPECT_EQ(packet1.windE, packet2.windE);
    EXPECT_EQ(packet1.magN, packet2.magN);
    EXPECT_EQ(packet1.magE, packet2.magE);
    EXPECT_EQ(packet1.magD, packet2.magD);
    EXPECT_EQ(packet1.magX, packet2.magX);
    EXPECT_EQ(packet1.magY, packet2.magY);
    EXPECT_EQ(packet1.magZ, packet2.magZ);
    EXPECT_EQ(packet1.Core, packet2.Core);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, NKF2_DATA)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_nkf2_data_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.TimeUS, packet2.TimeUS);
    EXPECT_EQ(packet_in.innovDragX, packet2.innovDragX);
    EXPECT_EQ(packet_in.innovDragY, packet2.innovDragY);
    EXPECT_EQ(packet_in.innovSideslip, packet2.innovSideslip);
    EXPECT_EQ(packet_in.accbiasX, packet2.accbiasX);
    EXPECT_EQ(packet_in.accbiasY, packet2.accbiasY);
    EXPECT_EQ(packet_in.accbiasZ, packet2.accbiasZ);
    EXPECT_EQ(packet_in.windN, packet2.windN);
    EXPECT_EQ(packet_in.windE, packet2.windE);
    EXPECT_EQ(packet_in.magN, packet2.magN);
    EXPECT_EQ(packet_in.magE, packet2.magE);
    EXPECT_EQ(packet_in.magD, packet2.magD);
    EXPECT_EQ(packet_in.magX, packet2.magX);
    EXPECT_EQ(packet_in.magY, packet2.magY);
    EXPECT_EQ(packet_in.magZ, packet2.magZ);
    EXPECT_EQ(packet_in.Core, packet2.Core);
...
TEST(ardupilotmega, CHALGAI)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::CHALGAI packet_in{};
    packet_in.TimeUS = 93372036854775807ULL;
    packet_in.innovDragX = 73.0;
    packet_in.innovDragY = 101.0;
    packet_in.innovSideslip = 129.0;
    ...
    mavlink::ardupilotmega::msg::CHALGAI packet1{};
    mavlink::ardupilotmega::msg::CHALGAI packet2{};
...
#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, CHALGAI)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_chalgai_encode(1, 1, &msg, &packet_c);
...
TEST(ardupilotmega, ORIGIN_MESSAGE)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::ORIGIN_MESSAGE packet_in{};
    packet_in.TimeUS = 93372036854775807ULL;
    packet_in.Type = 65;
    packet_in.Lat = 963497880;
    ...
    mavlink::ardupilotmega::msg::ORIGIN_MESSAGE packet1{};
    mavlink::ardupilotmega::msg::ORIGIN_MESSAGE packet2{};
...
#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, ORIGIN_MESSAGE)
{
    mavlink_message_t msg;
    ...
    mavlink_origin_message_t packet_c {
    ...
    mavlink_msg_origin_message_encode(1, 1, &msg, &packet_c);
