...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH -3779391876090599318
...
#include "./mavlink_msg_nkf2_data.h"
#include "./mavlink_msg_chalgai.h"
#include "./mavlink_msg_origin_message.h"
