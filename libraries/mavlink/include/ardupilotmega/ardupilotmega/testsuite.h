...
static void mavlink_test_nkf2_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_NKF2_DATA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_nkf2_data_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,18275,18379,18483,18587,18691,18795,18899,19003,19107,19211,19315,3
    };
    mavlink_nkf2_data_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.TimeUS = packet_in.TimeUS;
        packet1.innovDragX = packet_in.innovDragX;
        packet1.innovDragY = packet_in.innovDragY;
        packet1.innovSideslip = packet_in.innovSideslip;
        packet1.accbiasX = packet_in.accbiasX;
        packet1.accbiasY = packet_in.accbiasY;
        packet1.accbiasZ = packet_in.accbiasZ;
        ...
        packet1.Core = packet_in.Core;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_NKF2_DATA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_NKF2_DATA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_nkf2_data_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_nkf2_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_nkf2_data_pack(system_id, component_id, &msg , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_nkf2_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_nkf2_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_nkf2_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_nkf2_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_nkf2_data_send(MAVLINK_COMM_1 , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_nkf2_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("NKF2_DATA") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_NKF2_DATA) != NULL);
#endif
}

static void mavlink_test_chalgai(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CHALGAI >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_chalgai_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,18275,18379,18483,18587,18691,18795,18899,19003,19107,19211,19315,3
    };
    mavlink_chalgai_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.TimeUS = packet_in.TimeUS;
        packet1.innovDragX = packet_in.innovDragX;
        packet1.innovDragY = packet_in.innovDragY;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CHALGAI_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CHALGAI_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_chalgai_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_chalgai_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_chalgai_pack(system_id, component_id, &msg , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_chalgai_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_chalgai_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_chalgai_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_chalgai_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_chalgai_send(MAVLINK_COMM_1 , packet1.TimeUS , packet1.innovDragX , packet1.innovDragY , packet1.innovSideslip , packet1.accbiasX , packet1.accbiasY , packet1.accbiasZ , packet1.windN , packet1.windE , packet1.magN , packet1.magE , packet1.magD , packet1.magX , packet1.magY , packet1.magZ , packet1.Core );
    mavlink_msg_chalgai_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CHALGAI") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CHALGAI) != NULL);
#endif
}

static void mavlink_test_origin_message(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ORIGIN_MESSAGE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_origin_message_t packet_in = {
        93372036854775807ULL,963497880,963498088,963498296,65
    };
    mavlink_origin_message_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.TimeUS = packet_in.TimeUS;
        packet1.Lat = packet_in.Lat;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ORIGIN_MESSAGE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ORIGIN_MESSAGE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_origin_message_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_origin_message_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_origin_message_pack(system_id, component_id, &msg , packet1.TimeUS , packet1.Type , packet1.Lat , packet1.Lon , packet1.Alt );
    mavlink_msg_origin_message_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_origin_message_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.TimeUS , packet1.Type , packet1.Lat , packet1.Lon , packet1.Alt );
    mavlink_msg_origin_message_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_origin_message_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_origin_message_send(MAVLINK_COMM_1 , packet1.TimeUS , packet1.Type , packet1.Lat , packet1.Lon , packet1.Alt );
    mavlink_msg_origin_message_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ORIGIN_MESSAGE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ORIGIN_MESSAGE) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_nkf2_data(system_id, component_id, last_msg);
    mavlink_test_chalgai(system_id, component_id, last_msg);
    mavlink_test_origin_message(system_id, component_id, last_msg);
}
